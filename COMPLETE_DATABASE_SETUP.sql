-- ============================================
-- COMPLETE DATABASE SETUP - VOER DIT UIT IN SUPABASE SQL EDITOR
-- ============================================
-- Deze code reset alles en stelt het opnieuw in voor maximale compatibiliteit
...
-- Nu kunnen we de functies veilig verwijderen
...
-- BELANGRIJK: Deze policy moet ook werken voor de trigger functie
...
-- Dit is nodig omdat de trigger functie met SECURITY DEFINER draait
...
BEGIN
    ...
    -- Gebruik INSERT met ON CONFLICT om errors te voorkomen
...
-- ============================================
-- Zorg dat de functie de juiste permissions heeft
