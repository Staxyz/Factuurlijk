            ...
            <div className="flex items-center justify-center gap-2 sm:gap-6">
              ...
              {invoice.status === 'betaald' && (
                <button
                    ...
                    className="flex flex-col items-center justify-center p-2 rounded-lg text-sm font-medium text-yellow-700 hover:bg-yellow-50 transition-colors"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mb-1"><path d="M18 6 6 18"></path><path d="M6 6l12 12"></path></svg>
                    Open
                </button>
              )}
               <button
