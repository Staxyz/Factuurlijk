                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="bg-white p-6 sm:p-8 rounded-2xl border border-stone-200 shadow-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                        ...
                        <div className="mt-4 pt-4 border-t border-stone-200">
                             <a href="tel:+31612345678" className="block w-full text-center bg-stone-50 p-3 rounded-lg text-base font-medium text-blue-700 hover:text-blue-800 hover:bg-stone-100 transition-colors">+31 6 12 34 56 78</a>
                        </div>
                    </div>
                </div>
            </div>
